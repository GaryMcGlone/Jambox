...
@Component({
  selector: 'app-profile-action-sheet',
  templateUrl: './profile-action-sheet.component.html',
  styleUrls: ['./profile-action-sheet.component.scss']
})
export class ProfileActionSheetComponent implements OnInit {
  @Input() post: IPost;
  loggedIn: boolean;
  userId: string;
  likes: ILike[] = [];
