...
@Component({
  selector: 'app-profile-modal-post',
  templateUrl: './profile-modal-post.component.html',
  styleUrls: ['./profile-modal-post.component.scss']
})
export class ProfileModalPostComponent implements OnInit {
